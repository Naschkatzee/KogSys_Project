...
class Number(Attribute):
    ...
    def sample(self, min_level=NUM_MIN, max_level=NUM_MAX):
        ...
        self.value_level = np.random.choice(
            list(range(int(min_level), int(max_level) + 1))
        )
    ...
    def sample_new(self, min_level=None, max_level=None, previous_values=None):
        ...
        if min_level is None or max_level is None:
            ...
            values = list(range(int(min_level), int(max_level) + 1))
...
class Uniformity(Attribute):
    ...
    def sample(self):
        self.value_level = np.random.choice(list(range(int(self.min_level), int(self.max_level) + 1)))
